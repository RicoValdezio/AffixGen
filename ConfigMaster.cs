...
namespace AffixGen
{
    internal class ConfigMaster
    {
        internal static void Init()
        {
            ...
            AffixEquipBehaviour.maxStageLocks = AffixGenPlugin.Instance.Config.Bind(new ConfigDefinition("General Settings", "Max Stage Lock"), 1, new ConfigDescription("The maximum number of elite effects the basic equipment can give per stage", new AcceptableValueRange<int>(0,5))).Value;
        }
    }
}